...
function CompareCharts(props) {
    const [data, setData] = useState(getCompareData({ type: "init" }))
    ...
    const [currentView, setCurrentView] = useState(getInitCompareView())
    ...
    const [futureChartView, setFutureChartView] = useState(getInitCompareView())
    ...
    const handleChangeChartsView = () => {
        ...
        setData(getCompareData({ type: _type, year1: futureChartView.first.year, month1: futureChartView.first.month, year2: futureChartView.second.year, month2: futureChartView.second.month }))
